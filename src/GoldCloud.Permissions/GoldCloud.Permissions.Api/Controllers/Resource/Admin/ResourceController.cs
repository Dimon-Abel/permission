...
namespace GoldCloud.Permissions.Api.Controllers.Resource.Admin
{
    /// <summary>
    /// 资源
    /// </summary>
    ...
    public class ResourceController : AdminApiBaseController
    {
        ...
        [MethodInfo("Api资源分页查询", "管理后台Api资源分页查询接口")]
        ...
        [MethodInfo("ApiScope分页查询", "管理后台ApiScope分页查询接口")]

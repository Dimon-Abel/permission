...
namespace GoldCloud.Permissions.Api.Controllers.Resource.Mch
{
    /// <summary>
    /// 资源
    /// </summary>
    ...
    public class ResourceController : MchApiBaseController
    {
        ...
        [MethodInfo("Api资源分页查询", "商户后台Api资源分页查询接口")]
        ...
        [MethodInfo("ApiScope分页查询", "商户后台ApiScope分页查询接口")]

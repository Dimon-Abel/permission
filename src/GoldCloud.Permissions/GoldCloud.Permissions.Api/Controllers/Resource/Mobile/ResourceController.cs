...
namespace GoldCloud.Permissions.Api.Controllers.Resource.Mobile
{
    /// <summary>
    /// 资源
    /// </summary>
    ...
    public class ResourceController : MobileApiBaseController
    {
        ...
        [MethodInfo("Api资源分页查询", "移动平台Api资源分页查询接口")]
        ...
        [MethodInfo("ApiScope分页查询", "移动平台ApiScope分页查询接口")]

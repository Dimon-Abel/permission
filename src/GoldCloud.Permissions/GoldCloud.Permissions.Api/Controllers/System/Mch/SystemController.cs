...
namespace GoldCloud.Permissions.Api.Controllers.System.Mch
{
    /// <summary>
    /// 系统
    /// </summary>
    ...
    public class SystemController : MchApiBaseController
    {
        #region 获取系统详细信息
        ...
        [MethodInfo("获取系统详细信息", "商户后台获取系统详细信息接口")]
        ...
        [MethodInfo("获取系统列表", "商户后台获取系统列表接口")]
        ...
        [MethodInfo("获取所有系统信息", "商户后台获取所有系统信息接口")]

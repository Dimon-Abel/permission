...
namespace GoldCloud.Permissions.Api.Controllers.System.Mobile
{
    /// <summary>
    /// 系统
    /// </summary>
    ...
    public class SystemController : MobileApiBaseController
    {
        #region 获取系统详细信息
        ...
        [MethodInfo("获取系统详细信息", "移动平台获取系统详细信息接口")]
        ...
        [MethodInfo("获取系统列表", "移动平台获取系统列表接口")]
        ...
        [MethodInfo("获取所有系统信息", "移动平台获取所有系统信息接口")]

...
namespace GoldCloud.Permissions.Api.Controllers
{
    ...
    public class SystemController : ApiBaseController
    {
        ...
        [MethodInfo("获取系统详细信息", "默认内部获取系统详细信息接口")]
        ...
        [MethodInfo("获取系统列表", "默认内部获取系统列表接口")]
        ...
        [MethodInfo("获取所有系统信息", "默认内部获取所有系统信息接口")]

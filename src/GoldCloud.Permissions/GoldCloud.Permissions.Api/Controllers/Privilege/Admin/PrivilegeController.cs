...
namespace GoldCloud.Permissions.Api.Controllers.Privilege.Admin
{
    /// <summary>
    /// 权限
    /// </summary>
    ...
    public class PrivilegeController : AdminApiBaseController
    {
        #region 增删改
        ...
        [ProducesResponseType(typeof(bool), 200)]
        [MethodInfo("配置角色权限", "管理后台配置角色权限接口")]
        ...
        [ProducesResponseType(typeof(bool), 200)]
        [MethodInfo("删除角色权限", "管理后台删除角色权限接口")]
        ...
        [MethodInfo("获取所属系统权限树", "管理后台获取所属系统权限树接口")]
        ...
        [MethodInfo("获取权限列表", "管理后台获取权限列表接口")]
        ...
        [MethodInfo("获取权限详情", "管理后台获取权限详情接口")]
        ...
        [ActionName("children")]
        [ProducesResponseType(typeof(List<PermissionDto>), 200)]
        [MethodInfo("获取下级权限", "管理后台获取下级权限接口")]

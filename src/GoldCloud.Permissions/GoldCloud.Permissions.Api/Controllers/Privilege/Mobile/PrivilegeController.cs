...
namespace GoldCloud.Permissions.Api.Controllers.Privilege.Mobile
{
    /// <summary>
    /// 权限
    /// </summary>
    [ControllerName(ControllerNames.Permission)]
    [ApiExplorerSettings(GroupName = ApiGroupName.Mobile)]
    public class PrivilegeController : MobileApiBaseController
    {
        #region 根据角色获取权限信息
        ...
        [MethodInfo("获取所属系统权限树", "移动平台获取所属系统权限树接口")]
        ...
        [MethodInfo("获取权限列表", "移动平台获取权限列表接口")]
        ...
        [MethodInfo("获取权限详情", "移动平台获取权限详情接口")]
        ...
        [ActionName("children")]
        [ProducesResponseType(typeof(List<PermissionDto>), 200)]
        [MethodInfo("获取下级权限", "移动平台获取下级权限接口")]

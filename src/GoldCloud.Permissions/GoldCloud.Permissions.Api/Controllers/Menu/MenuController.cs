...
namespace GoldCloud.Permissions.Api.Controllers
{
    ...
    public class MenuController : ApiBaseController
    {
        ...
        [ProducesResponseType(typeof(bool), 200)]
        [MethodInfo("配置菜单权限", "默认内部配置菜单权限接口")]
        ...
        [ProducesResponseType(typeof(bool), 200)]
        [MethodInfo("不校验配置菜单权限", "默认内部不校验配置菜单权限接口")]
        ...
        [MethodInfo("根据角色获取菜单", "默认内部根据角色获取菜单接口")]
        ...
        [MethodInfo("获取系统菜单树", "默认内部获取系统菜单树接口")]
        ...
        [MethodInfo("获取菜单树(带权限树)", "默认内部获取菜单树(带权限树)接口")]
        ...
        [MethodInfo("获取菜单列表", "默认内部获取菜单列表接口")]
        ...
        [MethodInfo("获取菜单详情", "默认内部获取菜单详情接口")]
        ...
        [ActionName("children")]
        [ProducesResponseType(typeof(List<MenuDto>), 200)]
        [MethodInfo("获取下级菜单", "默认内部获取下级菜单接口")]

...
namespace GoldCloud.Permissions.Api.Controllers.Menu.Mch
{
    /// <summary>
    /// 菜单
    /// </summary>
    ...
    [ApiExplorerSettings(GroupName = ApiGroupName.Mch)]
    public class MenuController : MchApiBaseController
    {
        #region 增删改
        ...
        [ProducesResponseType(typeof(bool), 200)]
        [MethodInfo("配置菜单权限", "商户后台配置菜单权限接口")]
        ...
        [ProducesResponseType(typeof(bool), 200)]
        [MethodInfo("不校验配置菜单权限", "商户后台不校验配置菜单权限接口")]
        ...
        [MethodInfo("根据角色获取菜单", "商户后台根据角色获取菜单接口")]
        ...
        [MethodInfo("获取系统菜单树", "商户后台获取系统菜单树接口")]
        ...
        [MethodInfo("获取菜单树(带权限树)", "商户后台获取菜单树(带权限树)接口")]
        ...
        [MethodInfo("获取菜单列表", "商户后台获取菜单列表接口")]
        ...
        [MethodInfo("获取菜单详情", "商户后台获取菜单详情接口")]
        ...
        [ActionName("children")]
        [ProducesResponseType(typeof(List<MenuDto>), 200)]
        [MethodInfo("获取下级菜单", "商户后台获取下级菜单接口")]

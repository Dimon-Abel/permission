...
namespace GoldCloud.Permissions.Api.Controllers.Menu.Mobile
{
    /// <summary>
    /// 菜单
    /// </summary>
    ...
    public class MenuController : MobileApiBaseController
    {
        #region 根据角色获取菜单
        ...
        [MethodInfo("根据角色获取菜单", "移动平台根据角色获取菜单接口")]
        ...
        [MethodInfo("获取菜单列表", "移动平台获取菜单列表接口")]
        ...
        [MethodInfo("获取菜单详情", "移动平台获取菜单详情接口")]
        ...
        [ActionName("children")]
        [ProducesResponseType(typeof(List<MenuDto>), 200)]
        [MethodInfo("获取下级菜单", "移动平台获取下级菜单接口")]
